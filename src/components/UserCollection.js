...
export class CardList extends Component {
    ...
    let url = 'https://trading-card-organizer.herokuapp.com/api/cards'
    fetch(url)
    ...
    generatePrice() {
        ...
        let url = 'https://trading-card-organizer.herokuapp.com/api/cards/price'
        fetch(url)
        .then(response => response.json())
        .then(json => {
            console.log("setting the state.")
    ...
    deleteClick(card) {
        fetch('https://trading-card-organizer.herokuapp.com/api/cards/delete', {
            method: 'POST',
            headers: {
